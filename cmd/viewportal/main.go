...
func (s *stubSessionStore) ConsumeSignInChallenge(_ context.Context, _, _ *session.Session, prepareSuccessor func(), _ string, _ int32) (session.SignInChallengeResult, error) {
	prepareSuccessor()
	return session.SignInChallengeResult{}, nil
}
func (s *stubSessionStore) ConsumeRegistrationChallenge(_ context.Context, _, _ *session.Session, prepareSuccessor func(), _ string, _ int32, _ bool) (session.RegistrationChallengeResult, error) {
	prepareSuccessor()
...
func (s *stubSessionStore) Update(_ context.Context, _ *session.Session, update func()) error {
	update()
	return nil
}
func (s *stubSessionStore) Renew(_ context.Context, _, _ *session.Session, prepareSuccessor func()) error {
	prepareSuccessor()
	return nil
}
