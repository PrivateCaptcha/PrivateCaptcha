	...
	data := struct {
		...
		UsageReportContext: UsageReportContext{
			...
			TopProperties: []PropertyStat{
				{Name: "Main Site", Domain: "example.com", Count: 800, Percent: 64.8, PrevCount: 700, Change: 14.3, ChangeSign: "+"},
				{Name: "Blog", Domain: "blog.example.com", Count: 434, Percent: 35.2, PrevCount: 400, Change: 8.5, ChangeSign: "+"},
			},
		},
		UserName:    "John Doe",
