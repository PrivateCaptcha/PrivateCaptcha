...
func TestPayloadKeyNumericValuesRemainStable(t *testing.T) {
	fixtures := []struct {
		...
		{KeyVerifyRegistration, 12, "verify-registration"},
	}
...
func TestAuthoritativeSessionAccessorsAllowOnlyPayloadKeys(t *testing.T) {
	...
	allowed := []SessionKey{KeyUserEmail, KeyUserName, KeyNotificationID, KeyReturnURL, KeyOrgInviteID, KeyFirstSession, KeyAdhocNotification, KeyVerifyRegistration}
