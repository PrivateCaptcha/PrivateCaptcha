...
type Querier interface {
	...
	DeleteSessionsByID(ctx context.Context, sessionIds []string) (int64, error)
	...
	ExtendAuthenticatedSessionExpirations(ctx context.Context, arg *ExtendAuthenticatedSessionExpirationsParams) ([]*ExtendAuthenticatedSessionExpirationsRow, error)
	FinalizeRegistrationSession(ctx context.Context, arg *FinalizeRegistrationSessionParams) (*Session, error)
	...
	GetSessionByIDUnfiltered(ctx context.Context, sessionID string) (*Session, error)
	...
	ReissueRegistrationChallenge(ctx context.Context, arg *ReissueRegistrationChallengeParams) (*Session, error)
	ReissueSignInChallenge(ctx context.Context, arg *ReissueSignInChallengeParams) (*Session, error)
	...
	UpdateSessionDataCAS(ctx context.Context, arg *UpdateSessionDataCASParams) ([]*UpdateSessionDataCASRow, error)
