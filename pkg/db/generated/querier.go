...
type Querier interface {
	...
	GetDifficultyRulesByOrgIDs(ctx context.Context, dollar_1 []int32) ([]*GetDifficultyRulesByOrgIDsRow, error)
	GetDifficultyRulesByPropertyIDs(ctx context.Context, dollar_1 []int32) ([]*GetDifficultyRulesByPropertyIDsRow, error)
