...
func (c *memcache[TKey, TValue]) LoadFrom(ctx context.Context, r io.Reader, ttl time.Duration) error {
...
func userFormsCountCacheKey(userID int32) CacheKey {
	return Int32CacheKey(userFormsCountCacheKeyPrefix, userID)
}
