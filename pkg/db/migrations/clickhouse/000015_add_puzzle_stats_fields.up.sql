...
ALTER TABLE privatecaptcha.request_logs ADD COLUMN IF NOT EXISTS browser String DEFAULT '';
ALTER TABLE privatecaptcha.request_logs ADD COLUMN IF NOT EXISTS browser_major UInt16 DEFAULT 0;
ALTER TABLE privatecaptcha.request_logs ADD COLUMN IF NOT EXISTS os String DEFAULT '';
ALTER TABLE privatecaptcha.request_logs ADD COLUMN IF NOT EXISTS device String DEFAULT '';
