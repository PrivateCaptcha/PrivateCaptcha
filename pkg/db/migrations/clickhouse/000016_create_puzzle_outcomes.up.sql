...
(
    ...
    property_id UInt32,
    puzzle_id UInt64,
    user_id AggregateFunction(argMax, UInt32, UInt8),
    org_id AggregateFunction(argMax, UInt32, UInt8),
...
TTL expires_on + INTERVAL 3 DAY DELETE;
...
SELECT
    ...
    property_id,
    puzzle_id,
    argMaxState(user_id, toUInt8(1)) AS user_id,
    argMaxState(org_id, toUInt8(1)) AS org_id,
...
WHERE puzzle_id != 0
    ...
    AND expires_at <= nowInBlock('UTC') + INTERVAL 2 DAY
...
SELECT
    ...
    property_id,
    puzzle_id,
    argMaxState(user_id, toUInt8(0)) AS user_id,
    argMaxState(org_id, toUInt8(0)) AS org_id,
