...
func (q *scriptedPayloadQuerier) UpdateSessionPayloads(ctx context.Context, params *dbgen.UpdateSessionPayloadsParams) ([]*dbgen.UpdateSessionPayloadsRow, error) {
	q.mu.Lock()
...
func (q *lifecycleWorkerQuerier) UpdateSessionPayloads(_ context.Context, params *dbgen.UpdateSessionPayloadsParams) ([]*dbgen.UpdateSessionPayloadsRow, error) {
...
func (q *lifecycleWorkerQuerier) RenewSessionExpirations(_ context.Context, params *dbgen.RenewSessionExpirationsParams) ([]*dbgen.RenewSessionExpirationsRow, error) {
...
func TestSessionPayloadWorkerConflictEvictsOnlyMatchingVersion(t *testing.T) {
	...
	t.Run("Newer", func(t *testing.T) {
		...
		newer := session.NewSessionWithAuthority(session.Authority{State: session.StatePending, Version: 4, ExpiresAt: time.Now().Add(time.Hour)}, old.Payload())
