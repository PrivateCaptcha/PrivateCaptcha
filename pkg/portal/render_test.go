...
func TestRenderHTML(t *testing.T) {
	...
	*enterpriseOnly = true
	...
	testCases := []struct {
		...
		{
			path:     []string{common.OrgEndpoint, "123", common.ParamSearch},
		...
		{
			path:     []string{common.OrgEndpoint, "123", common.ParamSearch, "more-link"},
			template: orgSearchTemplate,
		...
		{
			path:     []string{common.OrgEndpoint, "123", common.ParamSearch, "more-oob"},
			template: orgSearchTemplate,
			model:    moreSearchModel,
		...
		{
			path:     []string{common.OrgEndpoint, "123", common.ParamSearch, "more-append"},
			template: orgSearchTemplate,
			model:    moreSearchModel,
		...
		{
			path:     []string{common.OrgEndpoint, "123", common.ParamSearch, "more-values"},
			template: orgSearchTemplate,
			model:    moreSearchModel,
			selector: `#searchMore button[hx-vals='{"search":"Searchable","offset":"10"}']`,
			matches:  []string{"Show more"},
		},
		{
			path:     []string{common.OrgEndpoint, "123", common.ParamSearch, "more-endpoint"},
			template: orgSearchTemplate,
			model:    moreSearchModel,
			selector: `#searchMore button[hx-get$="/org/123/search"]`,
			matches:  []string{"Show more"},
		},
