...
func TestGetOrgSearch(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			query := url.Values{common.ParamSearch: {tt.term}}
...
func TestGetOrgSearchRejectsInvalidRequests(t *testing.T) {
	...
	for _, values := range []url.Values{
		{common.ParamSearch: {"  "}},
		{common.ParamSearch: {"ab"}},
		{common.ParamSearch: {"abc@def"}},
		{common.ParamSearch: {"abc\tdef"}},
		{common.ParamSearch: {strings.Repeat("a", 256)}},
		{common.ParamSearch: {"valid"}, common.ParamOffset: {"invalid"}},
		{common.ParamSearch: {"valid"}, common.ParamOffset: {"-1"}},
		{common.ParamSearch: {"valid"}, common.ParamOffset: {strconv.FormatInt(int64(math.MaxInt32)+1, 10)}},
	} {
