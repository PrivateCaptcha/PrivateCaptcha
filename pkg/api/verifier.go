...
func (v *Verifier) PuzzleForRequest(r *http.Request, levels *difficulty.Levels, rulesPair *rules.RulesPair, ri *rules.RequestInfo) (puzzle.Puzzle, *dbgen.Property, error) {
	...
	accessRecord := v.createPuzzleAccess(property, fingerprint, result, tnow, ri)
...
func (v *Verifier) createPuzzleAccess(property *dbgen.Property, fingerprint common.TFingerprint, result puzzle.Puzzle, tnow time.Time, ri *rules.RequestInfo) *common.AccessRecord {
